...
<html lang="es">
    <head>
        ...
        {*<link href="{$_layoutParams.ruta_css}bootstrap_v2_1_1.css" rel="stylesheet" type="text/css">*}
        {*<link href="{$_layoutParams.ruta_css}bootstrap_v3_3_7.css" rel="stylesheet" type="text/css">*}
